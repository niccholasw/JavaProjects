...
import java.text.*; //import DecimalFormat class from java.text package
    ...
    public static void main(String[] args) { //main method
        ...
        while (true) { //loop until user enters -1
            ...
            if (earnings > 0) { //if earnings is positive
                System.out.println("Your stock has increased by " + df.format(earnings) + " per share on day " + day); //print earnings
            } else if (earnings < 0) { //if earnings is negative
                System.out.println("You stock has decreased by " + df.format(earnings) + " per share on day " + day); //print loss
